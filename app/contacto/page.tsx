...
function Contacto() {
  return (
    <div>
      <div>
        <h1 className="text-center text-3xl font-semibold py-2"></h1>
      </div>

      <div className="h-[79vh] bg-opacity-30 flex flex-col">
        <div className="h-1/2 p-4 flex items-center">
          <div>
            <h2 className="font-semibold text-xl">Escribenos:</h2>
            <a
            ...
            <div className="flex items-center justify-center py-10 text-5xl gap-x-20">
              <a href="">
                <FaFacebook />
              </a>
        ...
        <div className="bg-purple-400 h-1/2 rounded-xl overflow-hidden">
          <iframe
